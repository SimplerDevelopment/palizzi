  ...
  return (
    <section id="history" className="relative overflow-hidden" style={{ padding: 'clamp(4rem, 8vw, 8rem) 1.5rem', backgroundColor: '#0d0d0d' }}>
      <div className="absolute inset-0">
        {backgroundImage && <Image src={backgroundImage} alt="" fill className="object-cover" style={{ opacity: 0.15 }} sizes="100vw" />}
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          {paragraphs.map((p, i) => (
            <div key={i}>
              <p style={{ color: 'rgba(245,230,211,0.7)', lineHeight: 1.75, fontSize: 'clamp(1rem, 2vw, 1.125rem)' }} dangerouslySetInnerHTML={{ __html: getText(p) }} />
